...
//using Com.Google.Android.Exoplayer2.Chunk;
//using Com.Google.Android.Exoplayer2.Dash;
using Com.Google.Android.Exoplayer2.Drm;
//using Com.Google.Android.Exoplayer2.Hls;
...
using Java.IO;
using Java.Lang;
//using MediaFormat = Com.Google.Android.Exoplayer2;//.MediaFormat;
